...
for (int i = 0; i <= 500; i++) {
	...
	if ((GlobalVariable.M4_total_bonus_spins_int != 0) && (GlobalVariable.M4_spin_reels_symbols[2].contains("WILD_ExtraFG") || GlobalVariable.M4_spin_reels_symbols[3].contains("WILD_ExtraFG"))) {
		break
	}
...
//
//ArrayList<String> listOfKeys = new ArrayList<String>(extraFreeSpinFeatureStateKeys)
//
...
assert extraFreeSpinAdded == 5 || 10
