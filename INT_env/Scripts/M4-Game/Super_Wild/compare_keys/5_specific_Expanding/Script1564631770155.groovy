...
for (int i = 0; i <= 500; i++) {
	...
	if ((GlobalVariable.M4_total_bonus_spins_int != 0) && (GlobalVariable.M4_spin_reels_symbols[2].contains("WILD_Normal") || GlobalVariable.M4_spin_reels_symbols[3].contains("WILD_Normal") || GlobalVariable.M4_spin_reels_symbols[4].contains("WILD_Normal"))) {
		break
	}
...
ArrayList<String> Normal_keys = new ArrayList<String>(wildNormalFeatureStateKeys)
