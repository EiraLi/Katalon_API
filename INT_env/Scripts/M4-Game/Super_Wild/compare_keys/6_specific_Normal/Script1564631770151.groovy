...
for (int i = 0; i <= 500; i++) {
	...
	if ((GlobalVariable.M4_total_bonus_spins_int != 0) && (GlobalVariable.M4_spin_reels_symbols[2].contains("WILD_Double") || GlobalVariable.M4_spin_reels_symbols[4].contains("WILD_Triple"))) {
		break
	}
	else if ((GlobalVariable.M4_total_bonus_spins_int != 0) && (GlobalVariable.M4_spin_reels_symbols[2].contains("WILD_Triple") || GlobalVariable.M4_spin_reels_symbols[4].contains("WILD_Double"))) {
		break
	}
...
ArrayList<String> multi_keys = new ArrayList<String>(wildMultiplierFeatureStateKeys)
ArrayList<String> wildConfig_keys = new ArrayList<String>(wildMultiplierWildConfigeKeys)
