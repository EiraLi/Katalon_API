...
WS.sendRequestAndVerify(findTestObject('RGS(M4)/2_Round_detail', [('partner') : Partner
	, ('M4_spin_round_id') : GlobalVariable.M4_spin_round_id]))
def M4_round_All_keys = GlobalVariable.M4_round_reel_wins.keySet()
ArrayList<String> listofKeys = new ArrayList<String>(M4_round_All_keys)
