...
ArrayList<String> M4_round_object_key_list = new ArrayList<String>(M4_round_object_key)
ArrayList<String> M4_round_spin_result_key_list = new ArrayList<String>(M4_round_spin_result_key)
ArrayList<String> M4_round_feature_triggered_key_list = new ArrayList<String>(M4_round_feature_triggered_key)
ArrayList<String> M4_round_reel_key_list = new ArrayList<String>(M4_round_reel_key)
ArrayList<String> M4_round_feature_state_key_list = new ArrayList<String>(M4_round_feature_state_key)
ArrayList<String> M4_round_reels_symbols_key1 = new ArrayList<String>(M4_round_reels_symbols_key_1)
ArrayList<String> M4_round_reels_symbols_key2 = new ArrayList<String>(M4_round_reels_symbols_key_2)
ArrayList<String> M4_round_reels_symbols_key3 = new ArrayList<String>(M4_round_reels_symbols_key_3)
