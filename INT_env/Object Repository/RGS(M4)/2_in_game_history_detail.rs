...
<WebServiceRequestEntity>
   ...
   <name>2_in_game_history_detail</name>
   <tag></tag>
   <elementGuidId>0e8bc6e6-70f7-45d7-ab58-1bca6cf0eeef</elementGuidId>
...
def M4_history_kind = M4_history.game_history.bonuses[0].extra_spins_data[0].line_wins[0].kind
GlobalVariable.M4_history_kind = M4_history_kind

def M4_history_line_win_symbol = M4_history.game_history.bonuses[0].extra_spins_data[0].line_wins[0].symbol
GlobalVariable.M4_history_line_win_symbol = M4_history_line_win_symbol

def M4_history_prize = M4_history.game_history.bonuses[0].extra_spins_data[0].line_wins[0].prize
GlobalVariable.M4_history_prize = M4_history_prize

def M4_history_line_win_line = M4_history.game_history.bonuses[0].extra_spins_data[0].line_wins[0].line
GlobalVariable.M4_history_line_win_line = M4_history_line_win_line

def M4_history_line_win_multiplier = M4_history.game_history.bonuses[0].extra_spins_data[0].line_wins[0].wild_multiplier
GlobalVariable.M4_history_line_win_multiplier = M4_history_line_win_multiplier
