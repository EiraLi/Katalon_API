...
for (int i = 1; i <= 5; i++) {
    ...
    if (features == null) {
        spin_result = WS.sendRequestAndVerify(findTestObject('NuRGS/Take turn_Free_round', [('url') : 'nurgs.star9ad.com'
                    , ('booster_type') : 'REGULAR', ('game_code') : GlobalVariable.game_code, ('partner_code') : GlobalVariable.partner_code
                    , ('player_id') : GlobalVariable.player_id, ('rgs_session_token') : GlobalVariable.rgs_session_token
