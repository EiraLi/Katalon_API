...
//*****	Input game URL link to check able to launch game and performance is good *****
...
println('**** GlobalVariable.login_balance is: ****' + newline + GlobalVariable.login_balance.toPlainString())

println('**** GlobalVariable.balance is: ****' + newline + GlobalVariable.balance.toPlainString())
//assert login balance is not equal to balance after spin
assert GlobalVariable.login_balance != GlobalVariable.balance
...
println('**** GlobalVariable.login_round_id is: ****' + newline + GlobalVariable.login_round_id)
println('**** GlobalVariable.round_id is: ****' + newline + GlobalVariable.round_id)
		
//assert login round id is equal to latest round id after spin
assert GlobalVariable.login_round_id == GlobalVariable.round_id
