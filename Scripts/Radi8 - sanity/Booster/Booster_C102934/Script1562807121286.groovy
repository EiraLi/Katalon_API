...
//***When using free booster, balance is not deducted***
...
def booster_balance = GlobalVariable.booster_balance

println('*****login balance is:*****' + GlobalVariable.login_balance)

println('*****booster_balance is:*******' + GlobalVariable.booster_balance)

//login check balance, and compare with balance after booster spin
assert GlobalVariable.booster_balance >= GlobalVariable.login_balance
